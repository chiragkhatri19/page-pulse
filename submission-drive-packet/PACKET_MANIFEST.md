...
| `ARCHITECTURE.pdf` | Drive-preview-safe architecture document with the diagram embedded visibly. |
| `ARCHITECTURE_DIAGRAM.png` | Visible architecture diagram for Drive/GitHub preview. |
